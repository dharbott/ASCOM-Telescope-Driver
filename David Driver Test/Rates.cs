...
namespace ASCOM.Sepikascope001
{
    ...
    //
    // The Guid attribute sets the CLSID for ASCOM.Sepikascope001.Rate
    // The ClassInterface/None addribute prevents an empty interface called
    // _Rate from being created and used as the [default] interface
    //
    [Guid("4709e830-51d6-4ec0-9ae6-ddf0f54abd99")]
    ...
    // this polymorphism. 
    //
    // The Guid attribute sets the CLSID for ASCOM.Sepikascope001.AxisRates
    // The ClassInterface/None addribute prevents an empty interface called
    // _AxisRates from being created and used as the [default] interface
    //
    [Guid("293178be-58a2-46ff-aba4-567c125abff0")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComVisible(true)]
        ...
        internal AxisRates(TelescopeAxes axis)
        {
            ...
            switch (axis)
            {
                case TelescopeAxes.axisPrimary:
                    ...
                    this.rates = new Rate[] { new Rate(0.0166, 10) };
                    break;
    ...
    // this polymorphism. 
    //
    // The Guid attribute sets the CLSID for ASCOM.Sepikascope001.TrackingRates
    // The ClassInterface/None addribute prevents an empty interface called
    // _TrackingRates from being created and used as the [default] interface
    //
    [Guid("c7bf5eb0-44ac-40af-ac27-b46a5908a120")]
    [ClassInterface(ClassInterfaceType.None)]
    [ComVisible(true)]
